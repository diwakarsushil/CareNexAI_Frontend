			...
			{{if msgData.message}} \
				<li {{if msgData.type !== "bot_response"}} id="msg_${msgItem.clientMessageId}"{{/if}} class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon"> \
					<div class="buttonTmplContent"> \
						...
						<div class="{{if msgData.message[0].component.payload.fromHistory}} dummy messageBubbleForDropdown{{else}}messageBubbleForDropdown{{/if}}"> \
							{{if msgData.message[0].component.payload.heading}}<div class="templateHeading templateHeadingDropdown">${msgData.message[0].component.payload.heading}</div>{{/if}} \
...
var message= {
	...
	if(hostnameGTLOrUNL=="GTL"){
		systemTemplate = '<script id="chat_system_tmpl" type="text/x-jqury-tmpl"> \
    {{if msgData.message}} \
